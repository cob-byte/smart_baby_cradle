              ...
              child: Image(
               ...
               Padding(
                padding: const EdgeInsets.only(
                    bottom: 10, right: 0,), // Adjust as needed
                child: _pd.notificationTitles.isEmpty
                    ? Center(
                        child: Row(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Dismissible(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _pd.notificationRead[index] ? Theme.of(context).colorScheme.secondary : Theme.of(context).colorScheme.primary ,
