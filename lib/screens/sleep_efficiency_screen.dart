...
class SleepEfficiencyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sleep Efficiency Screen'),
      ),
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ChartLegend(
                            Color.fromARGB(255, 0, 2, 122), 'Hours of Sleep'),
                        SizedBox(width: 10),
                        ChartLegend(
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          double sleepEfficiency = (hoursOfSleepData[index] /
  ...
  FlTitlesData _buildTitlesData() {
    return FlTitlesData(
      ...
      bottomTitles: SideTitles(
        showTitles: true,
        getTitles: (value) {
          if (value % 2 == 0 && value >= 0 && value < daysOfWeek.length * 2) {
            return daysOfWeek[(value / 2).toInt()];
          }
          return '';
        },
      ),
